...
// www.leemon.com
//
// Wrapped in RequireJS, made globals local to module by Julian Ceipek 2014
//
// Version history:
// v 5.5  17 Mar 2013
...
// Added by Julian because of bug in expand
function elementExpand(x,n) {
  var ans=int2bigInt(0,0,(x.length>n ? x.length : n));
  copy_(ans,x);
  return ans;
}
